...
level_one = pygame.image.load('fon.png')
level_two = pygame.image.load('level_two.png')
level_three = pygame.image.load('level_three.png')
change_levels = pygame.image.load('change.png')

begin = pygame.image.load('fon_hi_new.png')
blue = pygame.image.load('fon_blue_new.png')
yellow = pygame.image.load('fon_yellow_new.png')
blue_win = pygame.image.load('fon_blue_win.png')
yellow_win = pygame.image.load('fon_yellow_win.png')
player_ppl = pygame.image.load('player_purple.png.')
...
def win12(screen):
    ...
    c = pygame.mixer.music.load('music_change_level.wav')
    pygame.mixer.music.play()
...
def draw(screen):
    ...
    vb = pygame.image.load("player_purple.png")

    pygame.mixer.music.load('flight_new.wav')
    pygame.mixer.music.play()
...
def draw2(screen):
    ...
    while run:
        ...
        if x >= 800 or x < 0 or y >= 600 or y < 0:
            ...
            pf = pygame.mixer.Sound('money.wav')
            pf.play()
            q = 1
